...
async def play(_, message: Message):
    ...
    try:
        ...
        await lel.edit(
            f"<b>هناك مشكلة لم استطيع دعوة الحساب المساعد ارسل الامر ( /userbotjoin ) حتا ينضم او قم بي اضافتة يدويا @Olinyomu</b>"
        )
        return
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("ᯓ˹ 𝑫𝑹: 𝑨𝑩𝑫𝑶 𝑲𝑯𝑨𝑰𝑹𝒀 🩺", url=f"t.me/Aashekelsafar"),
                    InlineKeyboardButton("𝐒𝐎𝐔𝐑𝐂𝐄🌀", url=f"t.me/A55B556"),
                ],
        ...
        try:
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("𝑫𝑹: 𝑨𝑩𝑫𝑶 𝑲𝑯𝑨𝑰𝑹𝒀 🩺", url=f"t.me/Aashekelsafar"),
                        InlineKeyboardButton("𝐒𝐎𝐔𝐑𝐂𝐄🌀", url=f"t.me/A55B556"),
                    ],
                    [InlineKeyboardButton(text="اغلاق القائمة", callback_data="cls")],
                ]
