...
⌁ ⁞   Developed By [𝑫𝑹: 𝑨𝑩𝑫𝑶 𝑲𝑯𝑨𝑰𝑹𝒀 🩺](https://t.me/Aashekelsafar)!**
</b>""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "🔮ⓜⓤⓢⓘⓒ🔮", url="https://t.me/Olinyomu")
                  ],[
                  InlineKeyboardButton(
                        "𝑫𝑹: 𝑨𝑩𝑫𝑶 𝑲𝑯𝑨𝑰𝑹𝒀 🩺", url="https://t.me/Aashekelsafar")
                  ],[
                    InlineKeyboardButton(
                       "𝐒𝐎𝐔𝐑𝐂𝐄🌀", url="https://t.me/A55B556"
                    ),
                    InlineKeyboardButton(
                        "🚨ⒷⒶⓇ🚨", url="https://t.me/O_L_Y_TEM"
                    )
                ],[
                    InlineKeyboardButton(
...
- رفض إرسال رسالة إلى المساعد في الخاص.
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "🚨ⒷⒶⓇ🚨", url=f"https://t.me/O_L_Y_TEM"
                    ),
                    InlineKeyboardButton(
                        "𝐒𝐎𝐔𝐑𝐂𝐄🌀", url=f"https://t.me/A55B556"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "𝑫𝑹: 𝑨𝑩𝑫𝑶 𝑲𝑯𝑨𝑰𝑹𝒀 🩺", url=f"https://t.me/Aashekelsafar"
                    )
                ]
            ]
        )
